...
--[[ Instanced Functions and Variables ]] do
    ...
    function INSTANCE:ApplyWeaponHelp()
        ...
        local bestObj = LocalPlayer():GetEyeTrace().Entity --[[@as Entity]]
        if IsValid( bestObj ) then
            -- "remember this guy"
        ...
        --typecheck.NotImplementedError( CLASS, "ApplyWeaponHelp" )
    end

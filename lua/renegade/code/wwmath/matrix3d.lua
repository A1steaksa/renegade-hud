...
--[[ Static Functions and Variables ]] do
    ...
    --[[ Matrix Multiplication Without Temporaries ]] do
        ...
        function STATIC.RotateVector( transformationMatrix, input )
            typecheck.NotImplementedError( "RotateVector" )
        end
    end
    ...
    function STATIC.SolveLinearSystem( system )
        typecheck.NotImplementedError( "SolveLinearSystem" )
    end
...
--- @overload fun( self: Matrix3dClass, matrixValues: number[] ): nil
---
--- @overload fun( self: Matrix3dClass, axis: Vector, angle: number ): nil
--- @overload fun( self: Matrix3dClass, rotation: Matrix3dInstance, pos: Vector ): nil
--- @overload fun( self: Matrix3dClass, rotation: QuaternionInstance, pos: Vector ): nil
---
--- @overload fun( self: Matrix3dClass, axis: Vector, sine: number, cosine: number ): nil
---
--- @overload fun( self: Matrix3dClass, x: Vector, y: Vector, z: Vector, pos: Vector ): nil
---
--- @overload fun( self: Matrix3dClass, m11: number, m12: number, m13: number, m14: number, m21: number, m22: number, m23: number, m24: number, m31: number, m32: number, m33: number, m34: number ): nil
...
--[[ Rotation ]] do
    ...
    function INSTANCE:SetRotation( ... )
        ...
        if typecheck.IsOfType( args[1], "QuaternionInstance" ) then
            typecheck.NotImplementedError( "Quaternion" )
            return
        end
    end
...
--[[ Look At ]] do
    ...
    function INSTANCE:EntityLookAt( p, target, roll )
        typecheck.NotImplementedError( "LookAt" )
    end
end
...
function INSTANCE:Copy3x3Matrix( matrix )
    typecheck.NotImplementedError( "Copy3x3Matrix" )
end
...
--[[ Orthogonal ]] do
    ...
    function INSTANCE:IsOrthogonal()
        typecheck.NotImplementedError( "IsOrthogonal" )
    end

    --- Force the Matrix to be orthogonal
    function INSTANCE:ReOrthogonalize()
        typecheck.NotImplementedError( "ReOrthogonalize" )
    end
end